...
public class ShopDetails implements Serializable {
	...
	public ShopDetails(String shopName, int shopNumber, int postalCode,
	...
	public String toString() {
		return "ShopDetails [shopName=" + shopName + ", shopNumber="
				+ shopNumber + ", postalCode=" + postalCode + ", longitude="
